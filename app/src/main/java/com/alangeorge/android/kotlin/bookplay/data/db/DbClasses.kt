...
class CityForecast(val map: MutableMap<String, Any?>, val forecasts: List<DayForecast>) {
    var _id: Long by map
    var city: String by map
    var country: String by map

    constructor(id: Long, city: String, country: String, forecasts: List<DayForecast>): this(HashMap(), forecasts) {
        this._id = id
        this.city = city
